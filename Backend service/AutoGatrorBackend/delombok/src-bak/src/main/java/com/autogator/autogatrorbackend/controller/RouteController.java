...
public class RouteController {
    ...
    @PostMapping
    public ResponseEntity<IrrigationRoute> insertRoute(@NotNull @RequestBody IrrigationRoute irrigationRoute) {
        return ResponseEntity.ok(irrigationRouteService.saveRoute(irrigationRoute));
    }

    @DeleteMapping
    public ResponseEntity<Object> removeRoute(@NotNull @RequestParam String routeName) {
        return ResponseEntity.ok(irrigationRouteService.removeRoute(routeName));
    }

    @GetMapping
    public ResponseEntity<IrrigationRoute> getRoute(@NotNull @RequestParam String routeName) throws Exception {
    ...
    public RouteController(final IrrigationRouteService irrigationRouteService) {
        this.irrigationRouteService = irrigationRouteService;
    }
}

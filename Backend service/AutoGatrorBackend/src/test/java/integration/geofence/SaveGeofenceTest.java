...
//        Assertions.assertEquals(1L, savedGeofenceEntity.getGeofenceInternalBoundaries().get(0).getGeofenceId());
//        Assertions.assertEquals(1L, savedGeofenceEntity.getGeofenceInternalBoundaries().get(1).getGeofenceId());
//    }
//
//}
